...
// 	protoc        v6.30.2
// source: common/base-response.proto
...
const file_common_base_response_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/base-response.proto\x12\x06common\"A\n" +
	...
	"\x11validation_errors\x18\x04 \x03(\v2\x17.common.ValidationErrorR\x10validationErrorsB/Z-github/eggnocent/app-grpc-eccomerce/pb/commonb\x06proto3"
