...
const file_order_order_proto_rawDesc = "" +
	...
	"\x11UpdateOrderStatus\x12\x1f.order.UpdateOrderStatusRequest\x1a .order.UpdateOrderStatusResponseB.Z,github/eggnocent/app-grpc-eccomerce/pb/orderb\x06proto3"
