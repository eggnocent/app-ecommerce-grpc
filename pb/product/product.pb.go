...
const file_product_product_proto_rawDesc = "" +
	"\n" +
	"\x15product/product.proto\x12\aproduct\x1a\x1acommon/base-response.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
	...
	"\rCreateProduct\x12\x1d.product.CreateProductRequest\x1a\x1f.product.CreatedProductResponseB0Z.github/eggnocent/app-grpc-eccomerce/pb/productb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	2, // 0: product.CreatedProductResponse.base:type_name -> common.BaseResponse
	0, // 1: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	1, // 2: product.ProductService.CreateProduct:output_type -> product.CreatedProductResponse
