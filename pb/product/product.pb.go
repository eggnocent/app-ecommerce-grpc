...
func (x *CreatedProductResponse) Reset() {
	*x = CreatedProductResponse{}
	mi := &file_product_product_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreatedProductResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreatedProductResponse) ProtoMessage() {}

func (x *CreatedProductResponse) ProtoReflect() protoreflect.Message {
	mi := &file_product_product_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreatedProductResponse.ProtoReflect.Descriptor instead.
func (*CreatedProductResponse) Descriptor() ([]byte, []int) {
	return file_product_product_proto_rawDescGZIP(), []int{1}
}

func (x *CreatedProductResponse) GetBase() *common.BaseResponse {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *CreatedProductResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_product_product_proto_rawDesc = "" +
	"\n" +
	"\x15product/product.proto\x12\aproduct\x1a\x1acommon/base-response.proto\x1a\x1bbuf/validate/validate.proto\x1a\x17common/pagination.proto\"\xbe\x01\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\rimageFileName\"R\n" +
	"\x16CreatedProductResponse\x12(\n" +
	...
	"\x04base\x18\x01 \x01(\v2\x14.common.BaseResponseR\x04base\x12:\n" +
	"\x04data\x18\x02 \x03(\v2&.product.HighlightProductsResponseItemR\x04data2\xca\x04\n" +
	"\x0eProductService\x12O\n" +
	"\rCreateProduct\x12\x1d.product.CreateProductRequest\x1a\x1f.product.CreatedProductResponse\x12N\n" +
	...
	"\x11HighlightProducts\x12!.product.HighlightProductsRequest\x1a\".product.HighlightProductsResponseB0Z.github/eggnocent/app-grpc-eccomerce/pb/productb\x06proto3"
...
var file_product_product_proto_goTypes = []any{
	...
	(*CreatedProductResponse)(nil),        // 1: product.CreatedProductResponse
...
var file_product_product_proto_depIdxs = []int32{
	17, // 0: product.CreatedProductResponse.base:type_name -> common.BaseResponse
	...
	1,  // 21: product.ProductService.CreateProduct:output_type -> product.CreatedProductResponse
